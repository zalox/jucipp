...
"    key_word = input_line[first_backwards_space+1:line_offset]\n"
"    libjuci.terminal.println(key_word)\n"
"    output = get_snippet(key_word)\n"
"    if output != key_word :\n"
"      libjuci.editor.erase_line_range(libjuci.editor.get_line_number(), first_backwards_space-1, line_offset)\n"
...
"                        \"action\":\"toolsplugin.open_favorite_folder\"\n"
"                    },\n"
"                    {\n"
