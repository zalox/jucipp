...
"import libjuci, os \n"
" \n"
"favorite = os.getenv(\"HOME\") # change to your favorite project \n"
" \n"
"def init() : \n"
"  append_project = \"\"\" \n"
"{ \n"
...
"  	\"item\" : { \n"
"  	    \"label\": \"Open favorite\", \n"
"  	    \"action\": \"toolsplugin.open_favorite\", \n"
...
"      \"action\": \"toolsplugin.open_plugin_folder\", \n"
"      \"keybinding\": \"<primary>p\" \n"
"    }, \n"
"    \"item\" : { \n"
"      \"label\": \"Open documentation\", \n"
"      \"action\": \"toolsplugin.open_documentation\", \n"
"      \"keybinding\": \"<primary><shift>p\" \n"
"    } \n"
"  } \n"
"} \n"
"  \"\"\" \n"
"  libjuci.add_menu_element(plugin_menu) \n"
"   \n"
" \n"
"def open_favorite() : \n"
"  libjuci.directories_open(favorite) \n"
" \n"
"def open_plugin_folder() : \n"
"  folder = libjuci.get_juci_home() \n"
"  folder += \"/plugins\" # may break windows  \n"
"  libjuci.directories_open(folder) \n"
" \n"
"def open_documentation() : \n"
"  libjuci.terminal_print(\"Not implemented yet\") \n"
" \n"
" \n"
  "init() \n";
std::string snippetpy = 
"import libjuci \n"
" \n"
"def init() : \n"
"  append = \"\"\" \n"
...
"	    \"keybinding\": \"<primary>h\" \n"
"	  }, \n"
"	  \"item\": { \n"
"	    \"label\": \"Open Documentation\", \n"
"	    \"action\": \"snippet.open_documentation\" \n"
"	  } \n"
"	} \n"
"      } \n"
"    } \n"
...
" \n"
"def insert_snippet() : \n"
"  input_line = libjuci.editor.get_line() \n"
"  if input_line != \"\" : \n"
"    line_offset = libjuci.editor.get_line_offset() \n"
"    first_backwards_space = input_line.rfind(\" \", 0, line_offset) \n"
"    if first_backwards_space == -1 : \n"
"      first_backwards_space = 0 \n"
"    key_word = input_line[first_backwards_space:line_offset] \n"
"    output = get_snippet(key_word) \n"
"    libjuci.terminal.println(key_word + \"\n\") \n"
"    libjuci.terminal.println(output + \"\n\") \n"
"    if output != key_word : \n"
"      libjuci.editor.erase_line_range(libjuci.editor.get_line_number(), first_backwards_space, line_offset) \n"
"      libjuci.editor.insert_at_cursor(output) \n"
" \n"
"init() \n";
